					...
					<div class="col-sm-6">
						...
						<div class="col-sm-6">
							<div class="form-group">
								...
								<table width="100%">
									<tr>
										<td width= "90%"><input class="form-control" type="text" name="unit_price" id="unit_price" placeholder="<?php echo $this->lang->line('unit_price_label')?> " value="<?php echo $item->unit_price; ?>"/></td>
