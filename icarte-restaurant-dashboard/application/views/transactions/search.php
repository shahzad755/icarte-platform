			...
			<div class='row'>
				<div class='col-sm-9'>
					...
					?>
					   	...
					   	style="float: left; margin-right: 20px;" value="<?php echo $searchterm;?>">
			              ...
			              <div class="input-group date form_datetime col-md-3" 
			              		...
			              		<input class="form-control" size="16" type="text" readonly name="start_date" value="<?php echo $start_date;?>">
						  ...
						  <div class="input-group date form_datetime col-md-3" 
							  	data-date-format="yyyy-mm-dd HH:ii:ss" data-link-field="dtp_input1" style="float: left; margin-right: 20px">
							  	<input class="form-control" size="16" type="text" readonly name="end_date" value="<?php echo $end_date;?>">
								<span class="input-group-addon"><span class="glyphicon glyphicon-th"></span></span>
						   </div>
						   <input type="hidden" id="dtp_input1" value=""/>
