						...
						<div id="<?php echo $trans->id;?>" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingOne">
							<div class="panel-body">
								...
								<?php
									...
									echo "<tr><td colspan='4' >Coupon Discount(-)</td><td>". $this->shop->get_current_shop()->currency_symbol .  $trans->coupon_discount_amount ."</td></tr>";
									echo "<tr><td colspan='4' >Shipping Charges(+)</td><td>". $this->shop->get_current_shop()->currency_symbol .  $trans->flat_rate_shipping ."</td></tr>";
									echo "<tr><td colspan='4' style='border-top:0px;'>Total Amount</td><td style='border-top:0px;'>". $this->shop->get_current_shop()->currency_symbol . floatval(($total_amount + $trans->flat_rate_shipping) - $trans->coupon_discount_amount )  ."</td></tr>";
									echo "</table>";
								?>
							</div>
						</div>
