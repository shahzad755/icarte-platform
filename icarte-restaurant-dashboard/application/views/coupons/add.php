...
<ul class="breadcrumb">
	...
	<li><?php echo $this->lang->line('add_new_coupon_button')?></li>
</ul>
	...
	<div class="row">
		<div class="col-sm-6">
				<div class="form-group">
					...
					<input class="form-control" type="text" placeholder="Coupon Name" name='coupon_name' id='coupon_name'>
				</div>
				...
				<div class="form-group">
					...
					<input class="form-control" type="text" placeholder="Coupon Code" name='coupon_code' id='coupon_code'>
				</div>
				
				<div class="form-group">
					<label><?php echo $this->lang->line('coupon_amount_label')?>
					&nbsp;(<?php echo $this->shop->get_current_shop()->currency_symbol; ?>)</label>
					<input class="form-control" type="text" placeholder="Coupon Discount Amount" name='coupon_amount' id='coupon_amount'>
