...
class Transactions extends Main
{
	...
	function index()
	{
		...
		$content['content'] = $this->load->view('transactions/list',$data,true);		
	...
	function update()
	{
		...
		if($this->transaction_header->update_status($this->input->post('transaction_status'),$this->input->post('header_id'))){
