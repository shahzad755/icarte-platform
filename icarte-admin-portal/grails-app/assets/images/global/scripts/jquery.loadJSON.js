...
*    Added option to avoid init method execution
*    Added option to implement custom onSetValue method
*    Replaced $().attr("value", newVal) with $().val(newVal)
*/
...
(function ($) {
    $.fn.loadJSON = function (obj, options) {
        ...
        function setElementValue(element, value, name) {
        	if (properties.onSetValue(name, value, element) != false) {
        ...
        var defaults = {
            onLoading: function () { },
            onLoaded: function () { },
            onSetValue: function (name, value, element) { },
            init: true
        };
