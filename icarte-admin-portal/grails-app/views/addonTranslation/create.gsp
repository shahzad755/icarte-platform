...
<html>
	...
	<body>
		<div class="portlet light portlet-fit portlet-form bordered" id="create-addonTranslation" role="main">
			...
			<div id="addonTranslation-create-portlet-body" class="portlet-body">
					...
					<form id="addonTranslationForm" method="post">					
						<div class="form-body">
						...
						<div class="form-actions right">
							<div class="row">
								<div class="col-md-offset-1">
									<button type="button" class="btn green-jungle" onclick="javascript: createAddonTranslation();">
