...
<html>
	...
	<body>
		...
		<div class="portlet light portlet-fit portlet-form bordered" id="edit-customer" role="main">
			<div class="portlet-title">
				<div class="caption font-blue">
					<i class="icon-note"></i><g:message code="default.edit.label" args="[entityName]" />
				</div>
			</div>
			<div id="customer-edit-portlet-body" class="portlet-body">
					...
					<form id="customerEditForm" method="post" <g:if test="${params.mode!='dlg'}">action='${request.contextPath}/${controllerName}/save'</g:if>>
						...
						<div class="form-actions right">
							<button type="button" class="btn green-jungle" onclick="<g:if test="${params.mode!='dlg'}">javascript: $('#customerEditForm').submit();</g:if><g:else>javascript: saveCustomer(true);</g:else>">
