...
<html>
	...
	<body>
		<div class="portlet light portlet-fit portlet-form bordered" id="create-feedbackConfigTranslation" role="main">
			<div class="portlet-title">
				<div class="caption font-blue">
					<i class="icon-note"></i><g:message code="default.create.label" args="[entityName]" />
				</div>
			</div>
			<div id="feedback-create-portlet-body" class="portlet-body">
					...
					<form id="feedbackConfigTranslationForm" method="post">					
						<div class="form-body">
						...
						<div class="form-actions right">
							<div class="row">
								<div class="col-md-offset-1">
									<button type="button" class="btn green-jungle" onclick="javascript: createFeedbackTranslation();">
