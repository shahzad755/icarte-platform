...
<html>
	<head>
		...
		<g:set var="entityName" value="${message(code: 'cuisineType.label', default: 'CuisineType')}" />
		<title><g:message code="default.edit.label" args="[entityName]" /></title>
		<script type="text/javascript">
			var _cuisineTypeId = ${cuisineTypeInstance?.id}
	...
	<body>
		...
		<div class="portlet light portlet-fit portlet-form bordered" id="edit-cuisineType" role="main">
			<div class="portlet-title">
				<div class="caption font-blue">
					<i class="icon-note"></i><g:message code="default.edit.label" args="[entityName]" />
				</div>
			</div>
			<div id="cuisine-portlet-body" class="portlet-body">
					...
					<div class="tabbable-custom">
						<ul class="nav nav-tabs">
							<li class="active">
								<a href="#tab_cuisine" data-toggle="tab"> Cuisine </a>
							</li>
							<li>
								<a href="#tab_cuisine_translation" data-toggle="tab"> Translations </a>
							</li>
							<li>
								<a href="#tab_cuisine_image" data-toggle="tab"> Media </a>
							</li>
						</ul>
						<div class="tab-content">
							<div class="tab-pane active" id="tab_cuisine">
								<g:form url="[resource:cuisineTypeInstance, action:'update']" method="PUT" >
									<g:hiddenField name="version" value="${cuisineTypeInstance?.version}" />							
									<div class="form-body">
									...
									<div class="form-actions right">
										...
										<button type="button" class="btn default"
											onclick="location.href='${request.contextPath}/${controllerName }/index'">
											<g:message code="default.button.cancel.label" />
										</button>
									</div>
								</g:form>
							</div>
							<div class="tab-pane" id="tab_cuisine_translation">
		                        <div class="table-toolbar">
		                            <div class="row">
		                                <div class="pull-right col-md-1">
		                                    <div class="btn-group">
		                                     <a id="btnAdd-cuisine-trans" class="btn btn blue btn-circle btn-icon-only btn-default" title="Create New Translation"
		                                     data-url="${createLink(uri: '/cuisineTranslation/create', params: [cuisineType: cuisineTypeInstance?.id])}" 
												data-toggle="modal">
									   				<i class="icon-plus"></i>
													</a>
											</div>
								...
								<table class="table table-striped table-hover table-bordered" id="cuisine_translation_tbl">
		                           <thead>
		                               <tr>
							...
							<div class="tab-pane" id="tab_cuisine_image">
								<div class="container">
								    ...
								    <form id="fileupload"  
								    	...
								    	<g:hiddenField name="id" value="${cuisineTypeInstance?.id}" />
...
{% } %}
		...
		<div id="cuisine-trans-modal" class="modal fade" tabindex="-1"  data-width="760">
		</div>
		<div id="cuisine-trans-edit-modal" class="modal fade" tabindex="-1"  data-width="760">
		</div>
	</body>
</html>
