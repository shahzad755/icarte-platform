...
<html>
	<head>
		...
		<script type="text/javascript">
			var _itemCatId = ${itemCategoryInstance?.id};
	...
	<body>
		...
		<div class="portlet light portlet-fit portlet-form bordered" id="edit-itemCategory" role="main">
			<div class="portlet-title">
				<div class="caption font-blue">
					<i class="icon-note"></i><g:message code="default.edit.label" args="[entityName]" />
				</div>
			</div>
			<div id="itemCat-portlet-body" class="portlet-body">
					...
					<div class="tabbable-custom">
						<ul class="nav nav-tabs">
							<li class="active">
								<a href="#tab_category" data-toggle="tab"> Item Category </a>
							</li>
							<li>
								<a href="#tab_category_translation" data-toggle="tab"> Translations </a>
							</li>
							<li>
						...
						<div class="tab-content">
							<div class="tab-pane active" id="tab_category">
								<g:form url="[resource:itemCategoryInstance, action:'update']" method="PUT" >
							...
							<div class="tab-pane" id="tab_category_translation">
		                        <div class="table-toolbar">
		                            <div class="row">
		                                <div class="pull-right col-md-1">
		                                    <div class="btn-group">
		                                     <a id="btnAdd-itemCat-trans" class="btn btn blue btn-circle btn-icon-only btn-default" title="Create New Translation"
		                                     data-url="${createLink(uri: '/itemCategoryTranslation/create', params: [itemCategory: itemCategoryInstance?.id])}" 
												data-toggle="modal">
									   				<i class="icon-plus"></i>
													</a>
											</div>
								...
								<table class="table table-striped table-hover table-bordered" id="itemCategory_translation_tbl">
		                           <thead>
		                               <tr>
...
{% } %}
		...
		<div id="itemCat-trans-modal" class="modal fade" tabindex="-1"  data-width="760">
		</div>
		<div id="itemCat-trans-edit-modal" class="modal fade" tabindex="-1"  data-width="760">
		</div>
	</body>
</html>
