...
<html>
	...
	<body>
		...
		<div class="portlet light portlet-fit portlet-form bordered" id="edit-restaurantDevice" role="main">
			...
			<div class="portlet-body">
					...
					<g:form url="[resource:restaurantDeviceInstance, action:'update']" method="PUT" >
						<g:hiddenField name="version" value="${restaurantDeviceInstance?.version}" />							
						<div class="form-body">
