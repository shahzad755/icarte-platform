...
<html>
	...
	<body>
		...
		<div class="portlet light portlet-fit portlet-form bordered" id="create-restaurantDevice" role="main">
			<div class="portlet-title">
				<div class="caption font-blue">
					<i class="icon-note"></i><g:message code="default.create.label" args="[entityName]" />
				</div>
			</div>
			<div id="restaurantDevice-portlet-body" class="portlet-body">
					...
					<g:form id="deviceRestaurantForm" url="[resource:restaurantDeviceInstance, action:'save']" >					
						<div class="form-body">
