...
<html>
	...
	<body>
		<div class="portlet light portlet-fit portlet-form bordered" id="edit-itemCatTranslation" role="main">
			<div class="portlet-title">
				<div class="caption font-blue">
					<i class="icon-note"></i><g:message code="default.edit.label" args="[entityName]" />
				</div>
			</div>
			<div id="itemCatTranslation-edit-portlet-body" class="portlet-body">
				...
				<form id="itemCatTranslationEditForm" method="post">					
					<div class="form-body">
					...
					<div class="form-actions right">
						<div class="row">
							<div class="col-md-offset-1">
								<button type="button" class="btn green-jungle" onclick="javascript: editItemCatTranslation(${itemCategoryTranslationInstance.id});">
