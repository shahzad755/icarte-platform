...
<html>
	...
	<body>
		<div class="portlet light portlet-fit portlet-form bordered" id="edit-restaurantEventTranslation" role="main">
			<div class="portlet-title">
				<div class="caption font-blue">
					<i class="icon-note"></i><g:message code="default.edit.label" args="[entityName]" />
				</div>
			</div>
			<div id="restaurantEventTranslation-edit-portlet-body" class="portlet-body">
					...
					<form id="restaurantEventTranslationEditForm" method="post">					
						<div class="form-body">
							<g:render template="form"/>
						</div>
						<div class="form-actions right">
							<button type="button" class="btn green-jungle" onclick="javascript: editRestaurantEventTranslation(${restaurantEventTranslationInstance.id});">
