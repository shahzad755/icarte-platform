...
<html>
	...
	<body>
		<div class="portlet light portlet-fit portlet-form bordered" id="create-itemTranslation" role="main">
			<div class="portlet-title">
				<div class="caption font-blue">
					<i class="icon-note"></i><g:message code="default.create.label" args="[entityName]" />
				</div>
			</div>
			<div id="itemTranslation-create-portlet-body" class="portlet-body">
					...
					<form id="itemTranslationForm" method="post">					
						<div class="form-body">
							<g:hiddenField id="itemVariant" name="itemVariant.id" value="${itemVariantTranslationInstance?.itemVariant?.id }"/>
							<g:render template="form"/>
						</div>
						<div class="form-actions right">
							<div class="row">
								<div class="col-md-offset-1">
									<button type="button" class="btn green-jungle" onclick="javascript: createItemTranslation();">
