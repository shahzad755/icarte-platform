 ...
 * @since 0.3.3
 */
@Deprecated // This is a shit class, contains lot of collision
class Hashids {
    public static final String DEFAULT_ALPHABET = "abcdefghjkmnpqrstuvwxyzABCDEFGHJKMNPQRSTUVWXYZ23456789"
    ...
    private String seps = "cfhstuCFHSTU"
